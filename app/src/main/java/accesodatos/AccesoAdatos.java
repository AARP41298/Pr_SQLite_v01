...
public class AccesoAdatos {
    ...
    public int DeleteClientes(Cliente cliente) throws SQLException {
        db = dbAdapter.getWritableDatabase();
    ...
    public Cliente QueryCliente(int ID) throws SQLException {
        db = dbAdapter.getWritableDatabase();
        Cursor cursor = db.query(SQLiteDB.TABLE_NAME, new String[]{SQLiteDB.KEY_NOMBRE, SQLiteDB.KEY_DIRECCION, SQLiteDB.KEY_TELEFONO, SQLiteDB.KEY_CIUDAD, SQLiteDB.KEY_ESTADO}, SQLiteDB.KEY_ID + "=?",
